...
var path       = require("path"),
    ...
    CSSModule      = require("./modules/css"),
    JSModule       = require("./modules/js"),
    YUIModule      = require("./modules/yui"),
    Group          = require("./group"),
    pathToUri      = require("./path-to-uri"),
...
Configger.prototype = {
    ...
    _modules : function() {
        var options = this.options,
            ...
            output  = path.join(options.root, options.output || "");
        ...
        modules = modules
            .filter(function(file) {
                // Ensure the output file isn't also being parsed
                if(options.output) {
                    return file !== output;
                }
