...
Configger.prototype = {
    ...
    run : function() {
        ...
        // TODO: this shouldn't be an error, we should still support
        // going & finding matching groupnames in the config template & updating
        // their definition.
        if(!template) {
            console.error("No group template found in config file");
